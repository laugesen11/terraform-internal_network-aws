...
variable "nat_gateways" {
  ...
  type = list(
    object({
      ...
      #Valid values include:
      #  - "make_elastic_ip"=<true|false>    - make a new elastic IP and attach to this NAT gateway
      #  - "is_public"=<true|false>          - makes this a public NAT Gateway. Otherwise this is private
